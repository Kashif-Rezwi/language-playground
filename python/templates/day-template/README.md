...
* **Description:** Build a function or block of logic to...
* **Expected Output:** ...

### Exercise 3: Advanced Challenge (Optional)
* **Description:** Optimize or handle edge cases for...
* **Expected Output:** ...
...
- [ ] Staged, committed, and pushed code to GitHub.
- [ ] Updated progress status and logged confidence score in `python/progress.md`.
